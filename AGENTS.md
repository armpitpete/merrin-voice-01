...
Stop only for authority conflict, unclear scope, unexplained validation failure, a necessary forbidden change, irreversible action requiring approval, or genuine human judgement.

## New-chat bootstrap

```text
Continue work on `armpitpete/merrin-voice-01`.
...
`STATUS.md` is the sole repository-level completion authority. Circuit, diagnostic, validation and manufacturing records are supporting evidence only.
